  ...
  const valuePropositions = [
    {
      ...
      description:
        "Strategic project timing to complete work during school breaks with zero classroom disruption",
    },
    {
      icon: Users,
      title: "Student Safety First",
      description:
        "Enhanced security protocols, background checks, and continuous site monitoring for active campus environments",
    },
    {
      icon: Leaf,
      title: "Sustainable Learning Spaces",
      description:
        "LEED-certified materials and energy-efficient systems to create healthy, eco-friendly educational environments",
    },
  ];
  ...
  const educationProjects = [
    {
      ...
      description:
        "New 45,000 sq ft STEM facility with specialized labs, lecture halls, and collaborative learning spaces",
    ...
    },
    {
      ...
      description:
        "Complete renovation of 18 classrooms, new gymnasium, and cafeteria upgrade with improved accessibility",
    ...
    },
    {
      ...
      description:
        "Built new 200-bed student residence with study lounges, communal kitchens, and sustainable design features",
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
                <h2 className="text-4xl font-bold text-center mb-12">
                  Why Educational Institutions Choose Ascent
                </h2>
              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-muted-foreground">
                    Building the future of learning, one campus at a time
                  </p>
                </div>
                <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="container mx-auto px-4 text-center">
              <div className="max-w-3xl mx-auto">
                <h2 className="text-4xl font-bold mb-6">
                  Planning Your Campus Project?
                </h2>
                <p className="text-xl mb-8 opacity-90">
                  Let's discuss how we can deliver your renovation or expansion
                  with zero disruption to the academic calendar.
                </p>

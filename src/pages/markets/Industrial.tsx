  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
          ...
          {/* Challenges */}
          <Section size="major">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">Industrial Construction Challenges</h2>
          ...
          {/* Services */}
          <Section size="major">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">Industrial Services</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <UnifiedCard variant="elevated">
                <h3 className="text-xl md:text-2xl font-semibold mb-4">New Construction</h3>
              ...
              <UnifiedCard variant="elevated">
                <h3 className="text-xl md:text-2xl font-semibold mb-4">Facility Upgrades</h3>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">•</span>

  ...
  const valuePropositions = [
    {
      ...
      description:
        "Overnight and weekend scheduling to keep your store open and revenue flowing during renovations",
    },
    {
      icon: TrendingUp,
      title: "Fast-Track Delivery",
      description:
        "Accelerated timelines to meet seasonal launches, grand openings, and critical sales periods",
    },
    {
      icon: Store,
      title: "Brand Experience Focus",
      description:
        "Precision execution of brand standards and design specifications for consistent customer experience",
    },
  ];
  ...
  const retailProjects = [
    {
      ...
      description:
        "Complete transformation of 15,000 sq ft retail space with modern fixtures, lighting, and experiential zones",
    ...
    },
    {
      ...
      description:
        "Renovated 12,000 sq ft food court with new seating, finishes, and infrastructure for 8 restaurant tenants",
    ...
    },
    {
      ...
      description:
        "Coordinated build-out of 14 new store locations across GTA for national retail chain",
              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-muted-foreground">
                    Creating exceptional retail environments that drive sales
                  </p>
                </div>
                <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="container mx-auto px-4 text-center">
              <div className="max-w-3xl mx-auto">
                ...
                <p className="text-xl mb-8 opacity-90">
                  Let's discuss how we can deliver your store renovation or
                  build-out without disrupting sales.
                </p>

  ...
  const valuePropositions = [
    {
      ...
      description:
        "Phased construction to keep rooms revenue-generating while renovating, with noise and dust mitigation protocols",
    },
    {
      icon: Clock,
      title: "Accelerated Timelines",
      description:
        "Fast-track delivery to minimize vacancy periods and maximize return on investment",
    },
    {
      icon: Sparkles,
      title: "Premium Finishes",
      description:
        "Expert execution of high-end finishes, millwork, and luxury materials that define guest experience",
    },
  ];
  ...
  const hospitalityProjects = [
    {
      ...
      description:
        "Complete transformation of 85-room boutique hotel including lobby, guest rooms, restaurant, and spa",
    ...
    },
    {
      ...
      description:
        "New 12,000 sq ft conference facility with ballroom, breakout rooms, and catering kitchen",
      metrics: "$6.8M project, completed for peak season",
      image:
        "https://images.unsplash.com/photo-1519167758481-83f29da8c9cb?w=800&h=600&fit=crop",
    },
    {
      name: "Restaurant and Bar Concept Build-Out",
      description:
        "Built upscale restaurant and cocktail lounge with custom millwork, show kitchen, and patio expansion",
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
                <h2 className="text-4xl font-bold text-center mb-12">
                  Why Hospitality Brands Choose Ascent
                </h2>
              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-muted-foreground">
                    Building spaces where memories are made
                  </p>
                </div>
                <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="container mx-auto px-4 text-center">
              <div className="max-w-3xl mx-auto">
                <h2 className="text-4xl font-bold mb-6">
                  Planning Your Hospitality Project?
                </h2>
                <p className="text-xl mb-8 opacity-90">
                  Let's discuss how we can renovate or expand your property
                  while maintaining guest satisfaction and revenue.
                </p>

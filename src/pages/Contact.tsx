...
const Contact = () => {
  ...
  const careersEmail =
    contactSettings?.careers_email || "careers@ascentgroupconstruction.com";
  const weekdayHours =
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-background to-muted/10">
      <SEO
        ...
        description="Contact Ascent Group for a free consultation and estimate. Serving the Greater Toronto Area with professional construction and project management services."
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <RippleEffect>
                      <Button
                        type="submit"
                        size="lg"
                        className="w-full h-16 text-lg gap-3 hover:scale-[1.02] transition-all shadow-lg hover:shadow-xl"
                    ...
                    <div className="bg-gradient-to-br from-muted/50 to-muted/30 border-2 border-border rounded-xl p-6 text-center">
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        <strong className="text-foreground text-base">
                          Privacy Notice:
                        </strong>{" "}
                        Your information is secure and will only be used to
                        respond to your inquiry. We never share your data with
                        third parties.
                      </p>
                    </div>
                  </form>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              See the transformations we deliver
            </p>
          </div>
          <div className="max-w-4xl mx-auto">
            <BeforeAfterSlider
      ...
      <section className="py-20 bg-gradient-to-b from-muted/50 to-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 animate-fade-in-up">
            ...
            <p className="text-lg text-muted-foreground">
              Located in Mississauga, proudly serving the Greater Toronto Area
            </p>
          </div>
          <div className="relative aspect-video bg-card rounded-2xl overflow-hidden shadow-2xl border-2 border-border hover:border-primary/30 transition-all">
            <iframe
              src={mapEmbedUrl}
              width="100%"
              height="100%"

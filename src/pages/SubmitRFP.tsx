                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) => setFormData({ ...formData, estimated_value_range: value })}
                          >
                            <SelectTrigger>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) => setFormData({ ...formData, bonding_required: checked as boolean })}
                          />
                          <Label className="font-normal">Bonding Required</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            checked={formData.prequalification_complete}
                            onCheckedChange={(checked) => setFormData({ ...formData, prequalification_complete: checked as boolean })}
                          />
                          <Label className="font-normal">I have completed the pre-qualification process</Label>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <ul className="text-sm text-muted-foreground space-y-1">
                            <li>• We'll review your RFP within 2 business days</li>

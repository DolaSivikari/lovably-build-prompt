...
const EIFSStucco = () => {
  ...
  const breadcrumbSchemaData = breadcrumbSchema([
    ...
    {
      name: "EIFS & Stucco",
      url: "https://ascentgroupconstruction.com/services/eifs-stucco",
    },
  ]);
  ...
  const deliverables = [
    {
      ...
      description:
        "Complete exterior insulation and finish systems with superior thermal performance and weather resistance.",
    },
    {
      icon: Droplets,
      title: "Traditional Stucco",
      description:
        "Classic cement-based stucco applications with modern waterproofing technology and lasting durability.",
    },
    {
      icon: Palette,
      title: "Custom Finishes",
      description:
        "Unlimited architectural designs with multiple textures, colors, and decorative elements.",
    },
    {
      icon: Award,
      title: "System Repairs",
      description:
        "Expert diagnosis and remediation of existing EIFS and stucco failures with comprehensive warranties.",
    },
  ];
  ...
  const process = [
    {
      ...
      description:
        "Wall assessment, moisture barrier installation, and insulation board attachment with proper drainage planes.",
    },
    {
      phase: "Base Coat & Mesh",
      description:
        "Base coat application with embedded reinforcing mesh for crack resistance and structural integrity.",
    },
    {
      phase: "Finish Application",
      description:
        "Final coat with selected texture and color, sealed and protected for maximum longevity.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHero.Root backgroundImage={heroImage}>
        ...
        <PageHero.Subtitle>
          Energy-efficient exterior finishes with superior aesthetics and
          lasting performance
        </PageHero.Subtitle>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Complete EIFS & Stucco Solutions
            </h2>
            <p className="text-lg text-muted-foreground">
              From new installations to system repairs, we deliver
              energy-efficient exterior finish systems that enhance building
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Factory-certified application methods ensuring optimal performance
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">
            Selected EIFS & Stucco Projects
          </h2>
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              {
                title: "Mixed-Use Development",
                detail: "150,000 SF EIFS system, Downtown Toronto",
              },
              {
                title: "Retail Complex Restoration",
                detail: "Complete EIFS repair and refinish, Mississauga",
              },
              {
                title: "Residential Tower",
                detail: "Energy-efficient EIFS retrofit, Markham",
              },
            ].map((project, index) => (
              <Card
                key={index}
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Enhance Your Building Exterior?
          </h2>

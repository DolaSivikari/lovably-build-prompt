...
const PaintingServices = () => {
  const serviceSchema = createServiceSchema({
    ...
    priceRange: '$$-$$$',
    subServices: ['Commercial Painting', 'Residential Painting', 'Condo & Multi-Unit Painting']
  });
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Professional Painting Services: Commercial, Residential & Multi-Unit | Ascent Group"
        description="Expert painting services for commercial buildings, residential homes, and condo/multi-unit properties. Interior & exterior painting across the GTA."
        keywords="painting services, commercial painting, residential painting, condo painting, multi-unit painting, interior painting, exterior painting"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Whether you're refreshing a commercial space, transforming your home, or managing a multi-unit property, 
              Ascent Group delivers exceptional painting results with minimal disruption.
            </p>
          </div>

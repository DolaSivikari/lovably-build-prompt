...
const ExteriorCladding = () => {
  ...
  const breadcrumbSchemaData = breadcrumbSchema([
    ...
    { name: "Services", url: "https://ascentgroupconstruction.com/services" },
    {
      ...
      url: "https://ascentgroupconstruction.com/services/exterior-cladding",
    },
  ]);
  ...
  const deliverables = [
    {
      ...
      description:
        "Traditional siding systems with modern materials offering low maintenance and lasting performance.",
    },
    {
      icon: Layers,
      title: "Engineered Wood Systems",
      description:
        "Premium wood-based cladding systems combining natural aesthetics with advanced weather protection.",
    },
    {
      icon: Palette,
      title: "Composite Cladding",
      description:
        "High-performance composite panels offering unlimited design options with superior durability.",
    },
    {
      icon: Shield,
      title: "Stucco & EIFS Systems",
      description:
        "Traditional stucco and Exterior Insulation Finishing Systems with superior thermal performance and design flexibility.",
    },
    {
      icon: CheckCircle2,
      title: "Sealants & Caulking",
      description:
        "Professional weatherproofing and building envelope protection with high-performance sealant systems.",
    },
    {
      icon: Shield,
      title: "Rainscreen Applications",
      description:
        "Ventilated rainscreen assemblies maximizing weather protection and building envelope performance.",
    },
  ];
  ...
  const process = [
    {
      ...
      description:
        "Material evaluation, design consultation, and performance review ensuring optimal cladding selection.",
    },
    {
      phase: "Envelope Preparation",
      description:
        "Weather barrier installation, drainage plane creation, and substrate preparation for cladding attachment.",
    },
    {
      phase: "Cladding Installation",
      description:
        "Precision installation with attention to details, transitions, and penetrations for lasting weathertightness.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHero.Root backgroundImage={heroImage}>
        ...
        <PageHero.Subtitle>
          Complete cladding solutions enhancing aesthetics and protecting
          building envelopes
        </PageHero.Subtitle>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              From traditional siding to modern composite systems, we install
              exterior cladding that protects your investment while enhancing
              curb appeal.
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Systematic approach ensuring proper envelope integration and
              lasting performance
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">
              Why Self-Perform Exterior Cladding
            </h2>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">
            Selected Cladding Projects
          </h2>
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              {
                title: "Multi-Family Residence",
                detail: "Complete fiber cement siding, 24 units, Markham",
              },
              {
                title: "Retail Complex Re-Clad",
                detail: "Composite panel system upgrade, Mississauga",
              },
              {
                title: "Commercial Building",
                detail: "Rainscreen cladding installation, Toronto",
              },
            ].map((project, index) => (
              <Card
                key={index}
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Upgrade Your Building Exterior
          </h2>
          <p className="text-xl mb-8 text-primary-foreground/90 max-w-2xl mx-auto">
            Expert cladding installation with superior weather protection and
            lasting aesthetics
          </p>

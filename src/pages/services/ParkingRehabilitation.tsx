...
const ParkingRehabilitation = () => {
  ...
  const breadcrumbSchemaData = breadcrumbSchema([
    ...
    {
      name: "Parking Rehabilitation",
      url: "https://ascentgroupconstruction.com/services/parking-rehabilitation",
    },
  ]);
  ...
  const deliverables = [
    {
      ...
      description:
        "Structural concrete repairs including spall repair, rebar replacement, and corrosion protection systems.",
    },
    {
      icon: HardHat,
      title: "Traffic Coating Systems",
      description:
        "Durable polyurethane and polyaspartic traffic membranes protecting against freeze-thaw and de-icing salts.",
    },
    {
      icon: Wrench,
      title: "Structural Strengthening",
      description:
        "Post-tensioning, carbon fiber reinforcement, and structural modifications to extend service life.",
    },
    {
      icon: Shield,
      title: "Joint & Sealant Systems",
      description:
        "Expansion joint replacement and comprehensive sealant programs preventing water intrusion.",
    },
  ];
  ...
  const process = [
    {
      ...
      description:
        "Structural engineering inspection, concrete testing, and corrosion mapping to determine rehabilitation scope.",
    },
    {
      phase: "Phased Restoration",
      description:
        "Strategic sequencing minimizing parking disruption while executing comprehensive concrete and coating repairs.",
    },
    {
      phase: "Protection Systems",
      description:
        "Traffic membrane installation, joint replacement, and corrosion inhibitor application for long-term protection.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHero.Root backgroundImage={heroImage}>
        ...
        <PageHero.Subtitle>
          Comprehensive restoration extending the life of parking structures
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              From structural concrete restoration to advanced traffic coatings,
              we rehabilitate parking structures with minimal disruption and
              maximum longevity.
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Strategic approach maximizing service life while minimizing
              operational impact
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">
              Why Self-Perform Parking Rehabilitation
            </h2>
            ...
            {[
              {
                ...
                detail: "6-level structure, complete restoration, Toronto",
              },
              {
                title: "Retail Complex Parking",
                detail: "180,000 SF traffic coating and repairs, Vaughan",
              },
              {
                title: "Residential Tower Garage",
                detail:
                  "Structural strengthening and waterproofing, Mississauga",
              },
            ].map((project, index) => (
              <Card
                key={index}
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Restore Your Parking Structure
          </h2>

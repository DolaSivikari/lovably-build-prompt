...
const InteriorBuildouts = () => {
  ...
  const breadcrumbSchemaData = breadcrumbSchema([
    ...
    { name: "Services", url: "https://ascentgroupconstruction.com/services" },
    {
      ...
      url: "https://ascentgroupconstruction.com/services/interior-buildouts",
    },
  ]);
  ...
  const deliverables = [
    {
      ...
      description:
        "Complete commercial buildouts from base building to turnkey occupancy with all trades coordinated.",
    },
    {
      icon: Layers,
      title: "Drywall & Metal Framing",
      description:
        "Precision framing and drywall installation with specialty finishes including curves and reveals.",
    },
    {
      icon: PaintBucket,
      title: "Interior Finishing",
      description:
        "Complete finishing packages including paint, millwork, flooring, and ceiling systems.",
    },
    {
      icon: Building2,
      title: "Suite Conversions",
      description:
        "Adaptive reuse and space reconfiguration transforming existing interiors for new functions.",
    },
  ];
  ...
  const process = [
    {
      ...
      description:
        "Architectural review, value engineering, and coordination with MEP trades for optimal buildout sequence.",
    },
    {
      phase: "Rough-In & Framing",
      description:
        "Metal framing installation, MEP rough-ins, and inspections before drywall enclosure.",
    },
    {
      phase: "Finishing & Closeout",
      description:
        "Drywall finishing, paint, flooring, millwork installation, and punch list completion for occupancy.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHero.Root backgroundImage={heroImage}>
        ...
        <PageHero.Subtitle>
          Complete interior construction from tenant improvements to precision
          finishing
        </PageHero.Subtitle>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              From commercial tenant improvements to complete suite buildouts,
              we deliver interior construction with quality craftsmanship and
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Coordinated execution ensuring quality finishes and on-time
              occupancy
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">
              Why Self-Perform Interior Buildouts
            </h2>
            ...
            {[
              {
                ...
                detail: "25,000 SF tenant improvement, Downtown Toronto",
              },
              {
                title: "Medical Clinic Suite",
                detail:
                  "Complete buildout with specialty finishes, Mississauga",
              },
              {
                title: "Retail Space Conversion",
                detail: "Adaptive reuse from office to retail, Vaughan",
              },
            ].map((project, index) => (
              <Card
                key={index}
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-primary-foreground/90 max-w-2xl mx-auto">
            Expert interior construction with coordinated execution and quality
            finishes
          </p>

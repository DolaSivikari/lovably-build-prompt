  ...
  const materialPractices = [
    {
      ...
      description:
        "100% of our paints and coatings are low or zero-VOC, improving indoor air quality and reducing environmental impact.",
      items: [
    ...
    },
    {
      ...
      description:
        "We prioritize suppliers within the GTA, reducing transportation emissions and supporting local businesses.",
      items: [
          ...
          <Card className="max-w-4xl mx-auto">
            <CardContent className="p-8 md:p-12">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  At Ascen Group Construction, we believe that beautifying the
                  GTA's buildings means protecting the environment for future
                  generations. Our commitment to sustainability isn't just a
                  policy—it's woven into every painting, stucco, and finishing
                  project we undertake.
                </p>
                <p>
                  From exclusively using low-VOC and zero-VOC materials to
                  implementing comprehensive waste diversion strategies, we're
                  dedicated to minimizing our environmental footprint. We
                  partner with eco-certified suppliers, properly dispose of all
                  materials, and continuously innovate our methods to reduce
                  environmental impact.
                </p>
                <p>
                  Our goal is to achieve carbon neutrality by 2030 while
                  maintaining the exceptional quality and craftsmanship our
                  clients expect.
                </p>
              </div>
            </CardContent>
              ...
              {stats.map((stat, index) => (
                ...
                >
                  <CardContent className="p-8">
                    <div
                      className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-muted mb-4 ${stat.color}`}
                    >
                ...
                <CardContent className="p-8 md:p-12">
                  <div className="max-w-2xl mx-auto">
                    ...
                    <p className="text-muted-foreground text-center mb-8">
                      Estimate the CO₂ offset achieved through our sustainable
                      painting practices
                    </p>
                    ...
                    <div className="space-y-4">
                      ...
                      {co2Offset > 0 && (
                        <div className="bg-white p-6 rounded-lg text-center animate-fade-in">
                          ...
                          <div className="text-xs text-muted-foreground">
                            Equivalent to planting {Math.ceil(co2Offset / 20)}{" "}
                            trees annually*
                          </div>
                        </div>
                      )}
                      ...
                      <p className="text-xs text-muted-foreground text-center">
                        *Calculation based on industry averages for eco-friendly
                        painting practices vs. conventional methods
                      </p>
                    </div>
                  </div>
                </CardContent>

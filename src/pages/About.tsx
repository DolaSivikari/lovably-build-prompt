  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        {/* Scale Capability Section */}
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-bold mb-4">Serving Projects of All Scales</h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="text-center hover:shadow-lg transition-shadow">
                  <CardContent className="p-8">
                    <div className="text-4xl font-bold text-primary mb-2">$5K - $5M+</div>
                    <p className="text-muted-foreground">Project Range</p>
                  </CardContent>
                </Card>
                <Card className="text-center hover:shadow-lg transition-shadow">
                  <CardContent className="p-8">
                    <div className="text-4xl font-bold text-primary mb-2">1,000+</div>
                    <p className="text-muted-foreground">Units Simultaneously</p>
                  </CardContent>
                </Card>
                <Card className="text-center hover:shadow-lg transition-shadow">
                  <CardContent className="p-8">
                ...
                <CardContent className="p-8 md:p-12">
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      <h3 className="text-2xl font-bold mb-3">Industrial-Grade Equipment</h3>
                      <p className="text-muted-foreground mb-4">
                        State-of-the-art tools and machinery for projects of any size. From spray systems to scaffolding, we have the resources to deliver excellence.
                      </p>
                      <Link to="/company/equipment-resources">
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="bg-gradient-to-br from-primary to-primary/80 text-primary-foreground">
                <CardContent className="p-8 md:p-12 text-center">
                  ...
                  <h3 className="text-3xl font-bold mb-4">Ready to Bid on Large Projects?</h3>
                  <p className="text-lg mb-6 opacity-90 max-w-2xl mx-auto">
                    Download our complete contractor package including certifications, insurance certificates, equipment lists, and pre-qualification documents.
                  </p>

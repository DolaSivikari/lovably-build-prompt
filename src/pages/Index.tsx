...
const Index = () => {
  ...
  const howToChooseContractor = createHowToSchema({
    ...
    description:
      "A step-by-step guide to selecting a qualified construction contractor for your commercial or residential project",
    steps: [
      {
        position: 1,
  ...
  const whyChooseUsSchema = {
    ...
    description:
      "Six key reasons to choose Ascent Group Construction for your Toronto and GTA construction projects",
    itemListElement: [
      {
        "@type": "ListItem",
        position: 1,
        ...
        description:
          "Fully licensed and insured with $5M liability coverage, WSIB compliant, and municipally licensed across the Greater Toronto Area with 500+ successful projects.",
      },
      {
        "@type": "ListItem",
        position: 2,
        ...
        description:
          "Comprehensive construction services including commercial construction, masonry repair, EIFS installation, metal cladding, and parking garage restoration throughout Toronto and the GTA.",
      },
      {
        "@type": "ListItem",
        position: 3,
        ...
        description:
          "Benjamin Moore and Sherwin-Williams authorized contractor using premium materials backed by extended manufacturer warranties.",
      },
      {
        "@type": "ListItem",
        position: 4,
        ...
        description:
          "95% on-time completion rate with transparent pricing, itemized estimates, and dedicated project management across Ontario.",
      },
      {
        "@type": "ListItem",
        position: 5,
        ...
        description:
          "OSHA certified crews with zero-incident safety record, comprehensive protocols, and full liability coverage.",
      },
      {
        "@type": "ListItem",
        position: 6,
        ...
        description:
          "Same-day emergency assessment and response throughout Greater Toronto Area with dedicated rapid response team.",
      },
    ],
  };

  const siteSearchSchema = createSiteSearchSchema(
    "https://ascentgroupconstruction.com",
  );

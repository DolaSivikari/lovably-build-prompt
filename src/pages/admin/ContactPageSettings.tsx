...
export default function ContactPageSettings() {
  ...
  const { errors, validate, getFieldError } = useSettingsValidation(
    ...
    try {
      ...
      if (data) {
        ...
        const loadedSettings = {
          ...
          business_hours:
            [data.weekday_hours, data.saturday_hours, data.sunday_hours]
              .filter(Boolean)
              .join("\n") || "",
          ...
          <CardContent>
            <div>
              ...
              <Textarea
                ...
                rows={3}
                className={
                  getFieldError("office_address") ? "border-destructive" : ""
                }
              />
          ...
          <CardContent className="space-y-4">
            <div>
                ...
                <FieldPreviewButton
                  onClick={() =>
                    openPreview(
                      "Office Phone",
                      "/contact",
                      "Main phone number in contact section",
                    )
                  }
                />
              </div>
              <Input
                ...
                className={
                  getFieldError("office_phone") ? "border-destructive" : ""
                }
              />
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input
                ...
                className={
                  getFieldError("office_email") ? "border-destructive" : ""
                }
              />
          ...
          <CardContent>
            <div>
              ...
              <Textarea
                ...
                rows={4}
                className={
                  getFieldError("business_hours") ? "border-destructive" : ""
                }
              />

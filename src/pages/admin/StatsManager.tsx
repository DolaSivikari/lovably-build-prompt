  ...
  const gcStatTemplates = [
    {
      ...
      value: 50000000,
      suffix: "M+",
      description: "Million in completed projects",
    ...
    },
    {
      ...
      value: 2000000,
      suffix: "+",
      description: "Sq ft of construction completed",
      icon_name: "Building2",
    },
    {
    ...
    },
    {
      ...
      value: 15,
      suffix: "+",
      description: "Years serving the GTA",
    ...
    },
    {
      ...
      value: 50,
      suffix: "+",
      description: "Certified tradespeople",
      icon_name: "Users",
    },
  ];
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              Click a template to quickly add GC-specific metrics to your
              homepage
            </p>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setEditingStat({ ...editingStat, icon_name: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div className="flex items-center gap-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setEditingStat({ ...editingStat, is_active: checked })
                  }
                />
                <Label>Active</Label>
              </div>
              ...
              <div className="flex justify-end gap-2 pt-4">
                ...
                <Button onClick={handleSave}>Save Stat</Button>
              </div>
            </div>
          </DialogContent>
        </Dialog>

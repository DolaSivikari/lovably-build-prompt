  ...
  useEffect(() => {
    const checkSlugUniqueness = async () => {
      ...
      setSlugStatus({
        ...
        message: isDuplicate ? "⚠️ This slug is already in use" : "✓ Available",
      });
    };
          ...
          <form onSubmit={handleSubmit} className="max-w-3xl space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={
                    !slugStatus.isAvailable ? "border-destructive" : ""
                  }
                />
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, project_size: e.target.value })
                  }
            ...
            <Card className="p-6 bg-card">
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Select all services that were provided for this project (e.g.,
                Stucco, Painting, Metal Cladding, etc.)
              </p>
            </Card>
            ...
            <Card className="p-6 bg-muted/30">
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setFormData({ ...formData, your_role: value })
                      }
                    >
                      <SelectTrigger>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Trade Contractor">
                          Trade Contractor
                        </SelectItem>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="trades_coordinated">
                      Trades Coordinated
                    </Label>
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          trades_coordinated: e.target.value,
                        })
                      }
                      placeholder="e.g., 12"
                    />
                    <p className="text-xs text-muted-foreground">
                      Number of subcontractor trades managed
                    </p>
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          peak_workforce: e.target.value,
                        })
                      }
                      placeholder="e.g., 45"
                    />
                    <p className="text-xs text-muted-foreground">
                      Maximum workers on site
                    </p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="on_time_completion">
                      On-Time Completion
                    </Label>
                    <Select
                    ...
                    {formData.team_credits.map((member: any, index: number) => (
                      <div key={index} className="grid grid-cols-12 gap-3">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() => {
                            const updated = formData.team_credits.filter(

  ...
  const benefits = [
    {
      ...
      description:
        "$10M per project with financial strength to handle large-scale developments",
    },
    {
      icon: Award,
      title: "Proven Track Record",
      description:
        "15+ years partnering with major GTA developers on 100+ multi-unit projects",
    },
    {
      icon: Calendar,
      title: "Fast-Track Capability",
      description:
        "Dedicated crews and equipment to meet aggressive development timelines",
    },
    {
      icon: TrendingUp,
      title: "Value Engineering",
      description:
        "Cost-saving alternatives without compromising quality or building code compliance",
    },
  ];
  ...
  const services = [
    {
      ...
      description:
        "Complete interior and exterior painting for residential and commercial developments",
      details: [
    ...
    },
    {
      ...
      description:
        "EIFS, stucco, masonry, and cladding installation with 15-year waterproofing warranties",
      details: [
    ...
    },
    {
      ...
      description:
        "Traffic coating systems, concrete restoration, and protective coatings for parking structures",
      details: [
        "Fast-cure systems",
        "Overnight/weekend scheduling",
  ...
  const process = [
    {
      ...
      description:
        "Submit comprehensive documentation including insurance, bonding, safety records, and references",
    },
    {
      step: "2",
      title: "RFP Response",
      description:
        "Detailed proposals with material specifications, crew schedules, and value engineering options",
    },
    {
      step: "3",
      title: "Contract & Coordination",
      description:
        "Formalized agreements with milestone schedules integrated with your project timeline",
    },
    {
      step: "4",
      title: "Execution & Delivery",
      description:
        "On-site project management, daily reporting, and quality assurance throughout construction",
    },
  ];
        ...
        <main id="main-content">
            ...
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-4">
                  Why Developers Choose Ascent
                </h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Financial strength, technical expertise, and track record you
                  can trust
                </p>
              </div>
          ...
          <section className="py-20 bg-muted/30">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-4">
                  Specialized Developer Services
                </h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Full-scope painting and building envelope solutions for new
                  construction
                </p>
              </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground mb-6 text-lg">
                          Access our complete contractor documentation including
                          insurance certificates, WSIB clearance, bonding
                          letters, safety certifications, financial statements,
            ...
            <div className="container mx-auto px-4 text-center">
              <div className="max-w-2xl mx-auto">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Discuss your upcoming development project and how we can

  ...
  const benefits = [
    {
      ...
      description:
        "Night and weekend scheduling available to avoid disrupting your business operations",
    },
    {
      icon: Timer,
      title: "Fast-Track Scheduling",
      description:
        "Accelerated timelines when you need to meet tight deadlines",
    },
    {
      icon: ShieldCheck,
      title: "Fully Insured",
      description:
        "$5M liability coverage and WSIB compliance - your business is protected",
    },
    {
      icon: Users,
      title: "Minimal Disruption",
      description:
        "Strategic planning and execution that keeps your business running smoothly",
    },
    {
      icon: Zap,
      title: "Low-VOC Materials",
      description:
        "Zero-odor, environmentally friendly products safe for occupied spaces",
    },
  ];
  ...
  const industries = [
    {
      ...
      description:
        "Professional finishes that create productive, attractive workspaces",
      features: [
    ...
    },
    {
      ...
      description:
        "Fast turnarounds that minimize impact on customer-facing operations",
      features: [
        "Quick rebrands",
        "Night-shift work",
        "Storefront painting",
    ...
    },
    {
      ...
      description:
        "Durable coatings and safety markings for high-traffic environments",
      features: [
    ...
    },
    {
      ...
      description:
        "Specialized finishes meeting strict regulatory and safety standards",
      features: [
        "Antimicrobial coatings",
        "Low-VOC products",
        "School break scheduling",
        "Patient area coordination",
      ],
    },
  ];
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              We follow a proven 6-step process to ensure your commercial

...
const Safety = () => {
  ...
  const safetyData = {
    commitment:
      aboutSettings?.safety_commitment ||
  ...
  const safetyFeatures = [
    {
      ...
      description:
        "Mandatory personal protective equipment for all team members on every job site",
    },
    {
      icon: AlertTriangle,
      title: "Hazard Assessment",
      description:
        "Comprehensive site analysis before project commencement to identify and mitigate risks",
    },
    {
      icon: ClipboardCheck,
      title: "Daily Safety Briefings",
      description:
        "Morning toolbox talks covering daily tasks, hazards, and safety procedures",
    },
    {
      icon: Users,
      title: "Certified Safety Officers",
      description:
        "Trained safety personnel on-site for all medium to large projects",
    },
  ];
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <Card className="text-center p-8 bg-primary text-primary-foreground hover:shadow-xl transition-shadow">
                ...
                <p className="text-lg opacity-90">
                  Projects with Zero Lost-Time Incidents
                </p>
              </Card>
              <Card className="text-center p-8 bg-primary text-primary-foreground hover:shadow-xl transition-shadow">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Comprehensive safety initiatives that protect our team,
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-muted-foreground">
                  Fully licensed, insured, and compliant with all safety
                  regulations
                </p>
              </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          All supervisors and project managers are OSHA 30-hour
                          certified
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Full Workplace Safety and Insurance Board coverage for
                          all employees
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Comprehensive general liability insurance protecting
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Certificate of Recognition for workplace health and

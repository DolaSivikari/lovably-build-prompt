...
const processSteps = [
  {
    ...
    duration: "1-2 days",
    description:
      "We visit your site to understand your needs, assess the scope, and provide a detailed quote.",
    details: [
  ...
  },
  {
    ...
    duration: "1-3 days",
    description:
      "Our team prepares the site and surfaces to ensure the highest quality finish.",
    details: [
  ...
  },
  {
    ...
    duration: "3-10 days",
    description:
      "Expert application using premium materials and proven techniques for lasting results.",
    details: [
  ...
  },
  {
    ...
    duration: "1 day",
    description:
      "We ensure everything meets our high standards and provide comprehensive warranty coverage.",
    details: [
...
const qualityStandards = [
  ...
  },
  {
    ...
    title: "Expert Team",
    description:
      "15+ years experience, certified professionals, background-checked",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Timeline varies by project size and complexity. Residential interiors (2000 sq ft): 3-7 days. Residential exteriors: 5-10 days weather permitting. Condo units: 2-4 days. Commercial projects: 1-4 weeks depending on scope. We provide detailed timelines during consultation and send daily progress updates.",
  },
  {
    question: "Can you work evenings or weekends for commercial projects?",
    answer:
      "Absolutely! We offer flexible scheduling including after-hours (6PM-6AM), weekends, and holiday work for commercial clients to minimize business disruption. After-hours work incurs a 20-30% premium but ensures zero impact on your operations. We've completed hundreds of commercial projects this way.",
  },
  {
    question: "What happens if I'm not satisfied with the work?",
    answer:
      "Your satisfaction is our priority. We conduct a thorough final walkthrough with you, and if anything doesn't meet your expectations, we'll address it immediately at no extra cost. All work comes with our satisfaction guarantee plus written warranties ranging from 2-10 years depending on the service.",
  },
  {
    question: "How do you handle weather delays for exterior projects?",
    answer:
      "For exterior painting, we require temperatures above 10°C and dry conditions for 48 hours before and after application. We monitor forecasts closely and adjust schedules proactively. Weather delays don't extend your contract price - we reschedule to the next suitable window at no extra cost to you.",
  },
  {
    question: "What's included in your estimates?",
    answer:
      "Our detailed estimates include: all materials (primer, paint, supplies), labor, surface preparation, furniture protection, daily cleanup, project management, insurance, and warranty. We provide line-item breakdowns so you understand exactly what you're paying for. No hidden fees, no surprises.",
  },
];
...
const OurProcess = () => {
  ...
  const howToSchema = generateHowToSchema({
    ...
    description:
      "Our proven 4-step construction and painting process ensures quality results from consultation to warranty",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Every project follows our time-tested 4-step methodology, refined
              over 15 years and 500+ successful completions
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-primary-foreground/90 text-lg">
              Over 15 years of consistent excellence across the GTA
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8 text-lg">
              Get a free consultation and detailed quote. No pressure, just

...
const AdminServices = lazy(() =>
  import("./pages/admin/Services").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
...
const AdminProjects = lazy(() =>
  import("./pages/admin/Projects").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
...
const ServiceEditor = lazy(() =>
  import("./pages/admin/ServiceEditor").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Service Editor</p>
      </div>
    ),
  })),
);
const ProjectEditor = lazy(() =>
  import("./pages/admin/ProjectEditor").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Project Editor</p>
      </div>
    ),
  })),
);
const ContactSubmissions = lazy(() =>
  import("./pages/admin/ContactSubmissions").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
...
const SiteSettings = lazy(() =>
  import("./pages/admin/SiteSettings").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
...
const TestimonialsManager = lazy(() =>
  import("./pages/admin/TestimonialsManager").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Testimonials Manager</p>
      </div>
    ),
  })),
);
const StatsManager = lazy(() =>
  import("./pages/admin/StatsManager").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Stats Manager</p>
      </div>
    ),
  })),
);
const AwardsManager = lazy(() =>
  import("./pages/admin/AwardsManager").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Awards Manager</p>
      </div>
    ),
  })),
);
const LeadershipTeam = lazy(() =>
  import("./pages/admin/LeadershipTeam").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
...
const RFPSubmissions = lazy(() =>
  import("./pages/admin/RFPSubmissions").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load RFP Submissions</p>
      </div>
    ),
  })),
);
const DocumentsLibrary = lazy(() =>
  import("./pages/admin/DocumentsLibrary").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Documents Library</p>
      </div>
    ),
  })),
);
const HomepageSettings = lazy(() =>
  import("./pages/admin/HomepageSettings").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
...
const FooterSettings = lazy(() =>
  import("./pages/admin/FooterSettings").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
...
const ContactPageSettings = lazy(() =>
  import("./pages/admin/ContactPageSettings").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Contact Page Settings</p>
      </div>
    ),
  })),
);
const AdminBlogPosts = lazy(() =>
  import("./pages/admin/BlogPosts").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
...
const BlogPostEditor = lazy(() =>
  import("./pages/admin/BlogPostEditor").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Blog Post Editor</p>
      </div>
    ),
  })),
);
const ResumeSubmissions = lazy(() =>
  import("./pages/admin/ResumeSubmissions").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Resume Submissions</p>
      </div>
    ),
  })),
);
const PrequalificationSubmissions = lazy(() =>
  import("./pages/admin/PrequalificationSubmissions").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Prequalification Submissions</p>
      </div>
    ),
  })),
);
const MediaLibrary = lazy(() =>
  import("./pages/admin/MediaLibrary").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
...
const SecuritySettings = lazy(() =>
  import("./pages/admin/SecuritySettings").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
...
const LandingMenuEditor = lazy(() =>
  import("./pages/admin/LandingMenuEditor").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Landing Menu Editor</p>
      </div>
    ),
  })),
);
const AboutPageSettings = lazy(() =>
  import("./pages/admin/AboutPageSettings").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load About Page Settings</p>
      </div>
    ),
  })),
);
const SettingsHealthCheck = lazy(() =>
  import("./pages/admin/SettingsHealthCheck").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Settings Health Check</p>
      </div>
    ),
  })),
);
const HeroSlidesManager = lazy(() =>
  import("./pages/admin/HeroSlidesManager").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Hero Slides Manager</p>
      </div>
    ),
  })),
);
const HeroImagesManager = lazy(() =>
  import("./pages/admin/HeroImagesManager").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Hero Images Manager</p>
      </div>
    ),
  })),
);
...
const BusinessDashboard = lazy(() =>
  import("./pages/admin/business/BusinessDashboard").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Business Dashboard</p>
      </div>
    ),
  })),
);
const BusinessClients = lazy(() =>
  import("./pages/admin/business/BusinessClients").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Business Clients</p>
      </div>
    ),
  })),
);
const BusinessProjects = lazy(() =>
  import("./pages/admin/business/BusinessProjects").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Business Projects</p>
      </div>
    ),
  })),
);
const BusinessEstimates = lazy(() =>
  import("./pages/admin/business/BusinessEstimates").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Business Estimates</p>
      </div>
    ),
  })),
);
const BusinessInvoices = lazy(() =>
  import("./pages/admin/business/BusinessInvoices").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Business Invoices</p>
      </div>
    ),
  })),
);
...
const ProjectDetail = lazy(() =>
  import("./pages/ProjectDetail").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Project Detail</p>
      </div>
    ),
  })),
);
const SEODashboard = lazy(() =>
  import("./pages/SEODashboard").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load SEO Dashboard</p>
      </div>
    ),
  })),
);
const AnimationShowcase = lazy(() =>
  import("./pages/AnimationShowcase").catch(() => ({
    default: () => (
      <div className="min-h-screen flex items-center justify-center">
        <p>Failed to load Animation Showcase</p>
      </div>
    ),
  })),
);
          ...
          <RouteTracker>
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route
                  path="/company/safety-and-compliance"
                  element={<Navigate to="/safety" replace />}
                />
                <Route
                  path="/prequalification"
                  element={<Prequalification />}
                />
                ...
                />
                <Route
                  path="/services/building-envelope"
                  element={<BuildingEnvelope />}
                />
                <Route
                ...
                <Route
                  ...
                  element={
                    <Navigate to="/services/exterior-envelope" replace />
                  }
                />
                <Route
                  path="/services/exterior-cladding"
                  element={<ExteriorCladding />}
                />
                <Route
                  path="/services/interior-buildouts"
                  element={<InteriorBuildouts />}
                />
                <Route
                  path="/services/exterior-envelope"
                  element={<ExteriorEnvelope />}
                />
                <Route path="/services/eifs-stucco" element={<EIFSStucco />} />
                <Route
                  path="/services/stucco-eifs"
                  element={<Navigate to="/services/eifs-stucco" replace />}
                />
                <Route
                  path="/services/masonry-restoration"
                  element={<MasonryRestoration />}
                />
                <Route
                  path="/services/metal-cladding"
                  element={<MetalCladding />}
                />
                <Route
                ...
                />
                <Route
                  path="/services/parking-rehabilitation"
                  element={<ParkingRehabilitation />}
                />
                ...
                <Route
                  path="/homeowners"
                  element={<Navigate to="/markets/multi-family" replace />}
                />
                <Route
                  path="/commercial-clients"
                  element={<CommercialClients />}
                />
                ...
                <Route path="/admin" element={<UnifiedAdminLayout />}>
                  ...
                  <Route
                    ...
                    element={<PrequalificationSubmissions />}
                  />

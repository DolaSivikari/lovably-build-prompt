...
const clientTypes = [
  {
    ...
    description: "Painting, restoration, and finishing for residential properties",
    benefits: ["Free estimates", "Flexible scheduling", "Warranty protection"],
  ...
  },
  {
    ...
    description: "Commercial painting and maintenance programs",
  ...
  },
  {
    ...
    description: "Reliable, certified partner for large-scale projects",

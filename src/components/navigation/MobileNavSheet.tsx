...
export function MobileNavSheet({ open, onOpenChange }: MobileNavSheetProps) {
  ...
  const {
    isScrollable: isServicesScrollable,
    isAtBottom: isServicesAtBottom,
    isAtTop: isServicesAtTop,
  } = useScrollIndicator(servicesContentRef);
  ...
  const visibleServiceItems = showMoreServices
    ? allServiceItems
    : allServiceItems.slice(0, 8);
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        ...
        style={{
          ...
          transition:
            swipeGesture.translateX === 0 ? "transform 0.3s ease-out" : "none",
        }}
        {...swipeGesture}
      >
        ...
        <div className="px-6 py-4">
          ...
          <div
            className="mb-4 animate-fade-in search-input-focus"
            style={{ animationDelay: "0.1s" }}
          >
            <div className="relative">
              <Search
                className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-primary pointer-events-none"
                aria-hidden="true"
              />
              <Input
                type="search"
            ...
            <>
                  ...
                  <div className="space-y-1">
                    {recommendations.map((item, index) => {
                      const IconComponent = getIcon(
                        NAVIGATION_ICONS[item.link] || "ChevronRight",
                      );
              ...
              <Accordion
                ...
                onValueChange={(value) => {
                  haptics.medium();
                  const actionText =
                    value.length > 0 ? "expanded" : "collapsed";
                ...
                <AccordionItem value="services" className="border-none">
                  ...
                  >
                    <NavCategoryCard
                      icon={Wrench}
                      title="Services"
                      itemCount={megaMenuDataEnhanced.services.reduce(
                        (acc, section) => acc + section.categories.length,
                        0,
                      )}
                  ...
                  >
                    ...
                    {megaMenuDataEnhanced.services.map(
                          ...
                          <div className="space-y-1">
                            {section.categories.map((category) => (
                              <div key={category.title} className="ml-1">
                                <div className="font-semibold text-sm py-1.5 px-2 text-foreground/90">
                                  {category.title}
                                </div>
                                {category.subItems && (
                                  <div className="ml-2 space-y-0.5">
                                    {category.subItems.map(
                                      (item, itemIndex) => {
                                        const IconComponent = getIcon(
                                          NAVIGATION_ICONS[item.link] ||
                                            "ChevronRight",
                                        );
                                        const description =
                                          NAVIGATION_DESCRIPTIONS[item.link];
                                        ...
                                        return (
                                          ...
                                          >
                                            <IconComponent
                                              className="h-4 w-4 flex-shrink-0 text-primary/60"
                                              aria-hidden="true"
                                            />
                                            <div className="flex-1 min-w-0">
                ...
                <AccordionItem value="markets" className="border-none">
                  ...
                  >
                    <NavCategoryCard
                      icon={Building}
                      title="Markets"
                      itemCount={megaMenuDataEnhanced.markets.reduce(
                        (acc, section) => acc + section.categories.length,
                        0,
                      )}
                  ...
                  <AccordionContent className="px-4 pb-4 pt-2">
                    {megaMenuDataEnhanced.markets.map(
                      (section, sectionIndex) => (
                        <div key={section.sectionTitle} className="mb-3">
                          {sectionIndex > 0 && <Separator className="my-3" />}
                          <h4 className="text-xs font-bold text-muted-foreground uppercase tracking-wide mb-2 px-2">
                                    ...
                                    {category.subItems.map(
                                      (item, itemIndex) => {
                                        ...
                                        return (
                                          ...
                                          >
                                            <IconComponent
                                              className="h-4 w-4 flex-shrink-0 text-secondary/60"
                                              aria-hidden="true"
                                            />
                                            <div className="flex-1 min-w-0">
                                              <span className="group-hover:translate-x-0.5 transition-transform block">
                ...
                <AccordionItem value="projects" className="border-none">
                  ...
                  >
                    <NavCategoryCard
                      icon={Building}
                      title="Projects"
                      itemCount={megaMenuDataEnhanced.projects.reduce(
                        (acc, section) => acc + section.categories.length,
                        0,
                      )}
                                  ...
                                  {category.subItems.map((item, itemIndex) => {
                                    ...
                                    return (
                                      <Link
                                        ...
                                        to={item.link}
                                        onClick={() =>
                                          handleLinkClick(item.name, "Projects")
                                        }
                                        onMouseDown={addRipple}
                                      ...
                                      >
                                        <IconComponent
                                          className="h-4 w-4 flex-shrink-0 text-accent/60"
                                          aria-hidden="true"
                                        />
                                        <div className="flex-1 min-w-0">
                                          <span className="group-hover:translate-x-0.5 transition-transform block">
                ...
                <AccordionItem value="company" className="border-none">
                  ...
                  >
                    <NavCategoryCard
                      icon={Users}
                      title="Company"
                      itemCount={megaMenuDataEnhanced.company.reduce(
                        (acc, section) => acc + section.categories.length,
                        0,
                      )}
                  ...
                  <AccordionContent className="px-4 pb-4 pt-2">
                    {megaMenuDataEnhanced.company.map(
                      (section, sectionIndex) => (
                        <div key={section.sectionTitle} className="mb-3">
                          {sectionIndex > 0 && <Separator className="my-3" />}
                          <h4 className="text-xs font-bold text-muted-foreground uppercase tracking-wide mb-2 px-2">
                ...
                <AccordionItem value="resources" className="border-none">
                  ...
                  >
                    <NavCategoryCard
                      icon={Building}
                      title="Resources"
                      itemCount={megaMenuDataEnhanced.resources.reduce(
                        (acc, section) => acc + section.categories.length,
                        0,
                      )}
                  ...
                  <AccordionContent className="px-4 pb-4 pt-2">
                    {megaMenuDataEnhanced.resources.map(
                      (section, sectionIndex) => (
                        <div key={section.sectionTitle} className="mb-3">
                          {sectionIndex > 0 && <Separator className="my-3" />}
                          <h4 className="text-xs font-bold text-muted-foreground uppercase tracking-wide mb-2 px-2">
        ...
        <div className="sticky bottom-0 left-0 right-0 p-4 border-t border-border/50 bottom-cta-enhanced backdrop-blur-xl animate-fade-in z-20">
          ...
          >
            <Link
              to="/estimate"
              onClick={() => handleLinkClick("Request Proposal", "CTA")}
              aria-label="Request a proposal for your project"
            >
              <Phone

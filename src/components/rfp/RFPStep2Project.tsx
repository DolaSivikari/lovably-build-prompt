        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Select
                value={projectType}
                onValueChange={(value) =>
                  setValue("project_type", value as any)
                }
              >
                <SelectTrigger
                  className={errors.project_type ? "border-destructive" : ""}
                >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Multi-Family Residential">
                    Multi-Family Residential
                  </SelectItem>
                  <SelectItem value="Institutional">Institutional</SelectItem>
                  <SelectItem value="Industrial">Industrial</SelectItem>
                  <SelectItem value="Renovation/Retrofit">
                    Renovation/Retrofit
                  </SelectItem>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setValue("estimated_value_range", value as any)
                }
              >
                <SelectTrigger
                  className={
                    errors.estimated_value_range ? "border-destructive" : ""
                  }
                >
              ...
              {errors.estimated_value_range && (
                <p className="text-sm text-destructive">
                  {errors.estimated_value_range.message}
                </p>
              )}
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Include full address if available, or general

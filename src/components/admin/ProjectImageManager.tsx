...
export const ProjectImageManager: React.FC<ProjectImageManagerProps> = ({
  ...
  const handleDrop = useCallback(
    async (e: React.DragEvent, category: string = "gallery") => {
      e.preventDefault();
      setIsDragging(false);
        ...
        {filteredImages.length === 0 ? (
          ...
          filteredImages.map((image) => (
            ...
            >
              ...
              {/* Image */}
              <div
                className={viewMode === "grid" ? "aspect-square" : "w-24 h-24"}
              >
                <img
                  src={image.url}
              ...
              >
                ...
                >
                  <Star
                    className={`w-4 h-4 ${image.featured ? "fill-yellow-400 text-yellow-400" : "text-muted-foreground"}`}
                  />
                </button>
                <button
              ...
              {viewMode === "list" && (
                <div className="flex-1">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleMoveCategory(image.id, e.target.value)
                    }
        ...
        >
          ...
          >
            ...
            {previewImage.caption && (
              <p className="mt-4 text-[hsl(var(--bg))] text-center text-lg">
                {previewImage.caption}
              </p>
            )}
          </div>

    ...
    try {
      ...
      if (data) {
        setContent({
          ...
          cta_secondary_text:
            data.cta_secondary_text || content.cta_secondary_text,
          cta_secondary_url:
            data.cta_secondary_url || content.cta_secondary_url,
          cta_tertiary_text:
            data.cta_tertiary_text || content.cta_tertiary_text,
    ...
    <section className="py-16 px-4 bg-background">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
          ...
          <p>
            From pre-construction planning to final closeout, our team delivers
            excellence through comprehensive project management, quality
            control, and proven construction methods. Every project is backed by
            detailed documentation, comprehensive warranties, and our commitment
            to safety and client satisfaction.
          </p>

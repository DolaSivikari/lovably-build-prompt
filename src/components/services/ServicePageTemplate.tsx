...
export const ServicePageTemplate = ({ service }: ServicePageTemplateProps) => {
  ...
  const quickFactsData = [
    ...
    {
      label: "Project Types",
      value: service.quickFacts.projectTypes[0] + " and more",
    },
  ];
    ...
    <div className="min-h-screen bg-background pt-20">
            ...
            <Card className="sticky top-8 shadow-lg">
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <p className="ml-7 text-sm text-muted-foreground">
                    {service.quickFacts.serviceArea}
                  </p>
                </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div
            className={`text-center mb-12 transition-all duration-700 ${benefitsInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
      ...
      >
        <div className="container mx-auto px-4">
          <div
            className={`text-center mb-12 transition-all duration-700 ${processInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Our Process
            </h2>
      ...
      {quickFactsData.length > 0 && (
        <section className="py-12 bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <QuickFacts
                title={`${service.name} Quick Facts`}
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                asChild
              >
                <Link to="/contact">Request Project Proposal</Link>
              </Button>
              <Button
                size="lg"
                variant="outline"

    ...
    <div className="space-y-6">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="standard">
              Standard - Light Sanding & Cleaning
            </SelectItem>
            <SelectItem value="heavy">
              Heavy - Extensive Repairs Needed
            </SelectItem>
        ...
        <>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => onChange("accessibility", value)}
            >
              ...
              <SelectContent>
                <SelectItem value="ground_floor">
                  Ground Floor / Low-Rise (1-3 stories)
                </SelectItem>
                <SelectItem value="mid_rise">Mid-Rise (4-8 stories)</SelectItem>
                <SelectItem value="high_rise">
                  High-Rise (9+ stories)
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div>
            ...
            <Select
              value={data.businessHoursConstraint}
              onValueChange={(value) =>
                onChange("businessHoursConstraint", value)
              }
            >
              ...
              <SelectContent>
                <SelectItem value="regular_hours">
        ...
        <>
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => onChange("unitCount", value)}
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="11_20">
                  11-20 Units (10% discount)
                </SelectItem>
                <SelectItem value="21_plus">
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                onChange("includeCommonAreas", checked)
              }
            />
          </div>
        </>
      ...
      {isSiding && (
        <div>
          ...
          <Select
            ...
            onValueChange={(value) => onChange("materialType", value)}
          >
      ...
      <div>
        ...
        >
          ...
          <SelectContent>
            <SelectItem value="gta_default">
              GTA Metro (Toronto, Mississauga, Brampton)
            </SelectItem>
